...
//    }
    /////////////////////======채용공고 크롤링 END======////////////////
    @GetMapping("/review/getauth")
    @ResponseBody
    public boolean getauth(){
        boolean result = reviewService.getauth(request.getSession().getAttribute("email").toString(), request.getSession().getAttribute("name").toString());
        return result;
    }
