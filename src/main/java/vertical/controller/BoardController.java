...
public class BoardController {
    ...
    public String view(@PathVariable("bno") int bno, Model model){
        ...
        if(optional.isPresent()){
            System.out.println(boardService.getboard(bno).get("mno"));
            if(boardService.getboard(bno).get("mno").equals(optional.get().getMno())){
//                model.addAttribute("myboard","true");
    ...
    public void getboardlist(HttpServletResponse response,
            ...
            @RequestParam("keyword") String keyword,
             ...
             @RequestParam("orderval") int orderval, @RequestParam("email") String email ){
