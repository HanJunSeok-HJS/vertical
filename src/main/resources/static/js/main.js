...
function mainboardlist(){
    ...
    $.ajax({
        ...
        for(let i = 0; i < object.length; i++){
            console.table(object[i].boardlist)
            ...
            if(i % 2 == 0){
               ...
               //  for (let j = 0; j < 5; j++){
               //      // html +=
               //      //     '<div class="col-md-9"><a href="/board/view/'+123+'">'+object[i].boardlist[j].btitle+'</a></div>';
               //      console.log(object[i].boardlist[j].bno)
               //  }
            }else{
                html +=
                        '    <div class="col-md-6 categoryboardbox">'+
...
function getcompanylist(){
    $.ajax({
        ...
        success : function(companylist){
            ...
            for(let i = 0; i < 10; i++){
                html +=
                    '<a href="/review/company/'+companylist[i].comname+'" style="text-decoration: none; color: black; ">' +
                   ' <div class="row" id="list123">'+
