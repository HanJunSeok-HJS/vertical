        ...
        success : function (list){
            ...
            for(let i = 0; i < list.length; i++){
                ...
                html += '<div>\n' +
                    ...
                    '\n' +
                    '                                        <div class="auth"><span class="writer">' + list[i].ewriter + '&nbsp;|&nbsp;</span>' + list[i].eoccupational_group + '&nbsp;|&nbsp;' + list[i].createdate + '</div>\n' +
                    '\n' +
                    '                                        <div>\n' +
                    '\n' +
                    '                                            <div class="paragraph">\n' +
                    ...
                    '                                                <p>\n' +
                    '                                                    <strong>단점</strong>\n' +
                    '                                                    <span class="cons">' + list[i].cons + '</span>\n' +
                    '                                                </p>\n' +
                    '                                            </div>\n' +
                    '\n' +
                    '                                            <div class="fnc">\n' +
                ...
                setTimeout(function (){
                    ...
                    if(list[i].ewriter.includes('현직원')){
                        $('#review_item' + list[i].eno).find('.auth').attr('class','auth verified');
                    }
